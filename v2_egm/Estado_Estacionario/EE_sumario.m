...
fprintf("Agregados:\n" + ...
        ...
        100*r, K_agg/Y_agg, W_agg, C_agg + eco.delta*K_agg - Y_agg);
...
fprintf("Dispersión (renta):\n" + ...
        "- Rentas del trabajo por cuantiles (simulación):    \t %s.\n" + ...
        "- Rentas del trabajo por quintiles (Francia, 2014): \t 3%% 11%% 17%% 19%% 42%%.\n" + ...
        "- Porcentaje de renta total recibido por el top %d%% (simulación):   \t %d%%.\n" + ...
        "- Porcentaje de renta total recibido por el top 10%% (Francia, 2014):\t 32%%.\n\n", ..., ...
        join(string(cuan_renta(1:end-1)) + "%"), top, cuan_renta(end));
fprintf("Dispersión (riqueza):\n" + ...
        "- Riqueza por cuantiles (simulación):    \t %s.\n" + ...
        "- Riqueza por quintiles (Francia, 2014): \t 1%% 6%% 13%% 21%% 59%%.\n" + ...
        "- Porcentaje de riqueza total recibido por el top %d%% (simulación):   \t %d%%.\n" + ...
        "- Porcentaje de riqueza total recibido por el top 10%% (Francia, 2014):\t 41%%.\n\n", ...
